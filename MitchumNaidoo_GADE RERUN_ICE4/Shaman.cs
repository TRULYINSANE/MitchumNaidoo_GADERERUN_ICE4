...
namespace MitchumNaidoo_GADE_RERUN_ICE4
{
    public class Shaman : Hero
    {
        ...
        //constructor
        public Shaman(int hp, int attack, int crit, int defense, string name, string battlecry) : base (hp ,attack, crit, defense, name, battlecry)
        {
            Hp = hp = SetHp();
        ...
        //methords
        public static void CreateShaman(int hp, int attack, int crit, int defense, string name, string battlecry)
        {
            SetHp();
            SetAtk();
            SetCrit();
            ...
            SetName();
            SetCry();
            Console.WriteLine(name + " the Shaman\nHp " + hp + "\nAttack " + attack + "\nDefense " + defense + "\nCritChance " + crit + "\nBattlecry " + battlecry);
        }
